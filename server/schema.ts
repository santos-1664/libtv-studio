...
export const settingsSchema = z.object({imageProvider:z.enum(['openai','bailian']).optional(),videoProvider:z.enum(['ark','bailian']).optional(),textBaseUrl:z.string().trim().max(2000).optional(),textKey:z.string().trim().max(16000).optional(),textModel:z.string().max(200).optional(),imageBaseUrl:z.string().max(2000).optional(),imageKey:z.string().max(16000).optional(),imageModel:z.string().max(200).optional(),videoBaseUrl:z.string().max(2000).optional(),videoKey:z.string().max(16000).optional(),videoModel:z.string().max(200).optional()}).strict();
